...
const Login = ({loginUser,meetingToken}) => {
    ...
    return(
        <div className="h-full flex-grow flex items-center justify-center flex-col gap-5">
            <input onChange={handleChange} id="meetingToken" type="text" defaultValue={meetingToken} className="focus:outline-none bg-transparent py-2 px-8 text-center w-120 border border-white rounded-full"/>
